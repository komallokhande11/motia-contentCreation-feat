...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'quality-assurance': EventHandler<{ platformContents: { blog?: string; twitter?: string[]; linkedin?: string; newsletter?: string }; context: { topic: string; audience: { persona: string; language?: string; readingLevel?: 'beginner' | 'intermediate' | 'expert' } } }, { topic: 'content.qa.completed'; data: { platformContents: { blog?: string; twitter?: string[]; linkedin?: string; newsletter?: string }; context?: { topic: string; audience: { persona: string; language: string; readingLevel?: string } }; schedule?: { when?: string }; metadata?: { topic: string; audience: { persona: string; language: string } } } }>
